  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Polityka prywatności serwisu kodypkd.app - informacje o przetwarzaniu danych osobowych." />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 space-y-6 text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p>
                Administratorem serwisu kodypkd.app jest jego właściciel. W sprawach dotyczących ochrony danych
                osobowych prosimy o kontakt za pośrednictwem danych podanych na stronie głównej.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li><strong>Zapytania wyszukiwania</strong> — opisy działalności wpisywane w formularz wyszukiwarki są przesyłane do serwera w celu dopasowania kodów PKD. Nie są one powiązane z tożsamością użytkownika.</li>
                <li><strong>Dane techniczne</strong> — adres IP, typ przeglądarki, system operacyjny — zbierane automatycznie przez serwer w celach technicznych i bezpieczeństwa.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                Dane przetwarzane są na podstawie art. 6 ust. 1 lit. f) RODO — prawnie uzasadniony interes
                administratora polegający na świadczeniu usługi i zapewnieniu jej bezpieczeństwa.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Serwis wykorzystuje wyłącznie techniczne pliki cookies niezbędne do prawidłowego działania
                strony (np. przechowywanie stanu sesji). Nie stosujemy cookies marketingowych ani śledzących.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                Mogą być udostępniane dostawcom usług hostingowych (Vercel) wyłącznie w zakresie niezbędnym
            ...
            <section>
              ...
              <p>
                Dane techniczne (logi serwera) przechowywane są przez okres nie dłuższy niż 30 dni.
                Zapytania wyszukiwania nie są trwale zapisywane.
              </p>
            </section>
          </div>
        </div>
